        ...
        <div className={isArchived ? 'opacity-60' : ''}>
          ...
          {wine.features && (
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300 text-[15px] leading-relaxed">
                {searchQuery ? highlightText(wine.features, searchQuery) : wine.features}
              </p>
            </div>
          )}
          ...
          {wine.reference_info && String(wine.reference_info).trim() && (
            <div
              ref={(el) => {
